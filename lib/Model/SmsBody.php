 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SmsBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'smsBody';
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['body']) > 90)) {
            $invalidProperties[] = "invalid value for 'body', the character length must be smaller than or equal to 90.";
        }
    ...
    public function setTemplateId($templateId)
    {
        if (!is_null($templateId) && (mb_strlen($templateId) > 50)) {
            throw new \InvalidArgumentException('invalid length for $templateId when calling SmsBody., must be smaller than or equal to 50.');
        }
    ...
    public function setBody($body)
    {
        if ((mb_strlen($body) > 90)) {
            throw new \InvalidArgumentException('invalid length for $body when calling SmsBody., must be smaller than or equal to 90.');
        }
    ...
    public function setSendNo($sendNo)
    {
        if ((mb_strlen($sendNo) > 13)) {
            throw new \InvalidArgumentException('invalid length for $sendNo when calling SmsBody., must be smaller than or equal to 13.');
        }
    ...
    public function setUserId($userId)
    {
        if (!is_null($userId) && (mb_strlen($userId) > 100)) {
            throw new \InvalidArgumentException('invalid length for $userId when calling SmsBody., must be smaller than or equal to 100.');
        }
